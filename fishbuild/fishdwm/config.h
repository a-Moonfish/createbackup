...
/* static const char font[]                 = "UbuntuMono Nerd Font 9"; */
static const char font[]                 = "Futura-Bold 16";
/* static const char font[]                 = "Futura-Bold 8"; */
...
static char *tagicons[][NUMTAGS] = {
	[DEFAULT_TAGS]        = { "Arowana", "Bonito", "Catfish", "Discus", "ElectricEel", "Flounder", "Gourami", "Humuhumunukunukuapua'a", "Icefish" },
...
static Key keys[] = {
	...
	{ 0, XF86XK_Tools,	                spawn,		SHCMD("fishscreenset") },
	{ MODKEY,			XK_w,	       spawn,	SHCMD("qutebrowser") },
	{ MODKEY,			XK_t,	       spawn,	SHCMD("fishwalldwm") },
	{ MODKEY|ShiftMask,		XK_w,	       spawn,	SHCMD("st -e sudo nmtui") },
	{ MODKEY,            		XK_r,	       spawn,	SHCMD("st -e  vifm") },
	{ MODKEY|ShiftMask,		XK_r,	       spawn,	SHCMD("st -e sudo vifm") },
...
/*      { MODKEY,                       XK_d,          incnmaster,             {.i = -1 } },*/
	...
	{ MODKEY,			XK_Escape,     spawn,	    SHCMD("poweroffscript") },
